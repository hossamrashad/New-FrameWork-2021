...
$(document).ready(function () {
  ...
  $(".tabs-list li").on("click", function () {
    $(this).addClass("active").siblings().removeClass("active"); //console.log($(this).data("content"));

    $(".content-list > div").hide();
    $($(this).data("content")).fadeIn();
  }); // section box haver

  $(document).on("mouseover", ".css-section-haver-box-parent .column", function () {
    "use strict";
...
function openMenu() {
  ...
  var menu = document.querySelector(".menu-Plus");
...
function readmore() {
  ...
  blur.classList.toggle("activeShow"); // Show Popup
